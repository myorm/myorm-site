...
<h2 class="h2">.andThatHasOne()</h2>
<div class="p-4">
    <Docs {exampleCode}>
        Further configure one-to-one relationship from the last configured relationship on your <code class="code">MyORMContext</code> class object to be included in future queries.
